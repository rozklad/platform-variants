...
return [
	...
	*/
	...
	'description' => 'Adds functionality to define product variants',
	...
	*/
	...
	'providers' => [
		...
		'Sanatorium\Variants\Providers\VariantServiceProvider',
	...
	*/
	...
	{
		Route::group([
				'prefix'    => admin_uri().'/variants/variants',
				'namespace' => 'Sanatorium\Variants\Controllers\Admin',
			], function()
			{
				...
				Route::get('create' , ['as' => 'admin.sanatorium.variants.variants.create', 'uses' => 'VariantsController@create']);
				Route::post('create', ['as' => 'admin.sanatorium.variants.variants.create', 'uses' => 'VariantsController@store']);

				Route::get('{id}'   , ['as' => 'admin.sanatorium.variants.variants.edit'  , 'uses' => 'VariantsController@edit']);
				Route::post('{id}'  , ['as' => 'admin.sanatorium.variants.variants.edit'  , 'uses' => 'VariantsController@update']);

				Route::delete('{id}', ['as' => 'admin.sanatorium.variants.variants.delete', 'uses' => 'VariantsController@delete']);
			});

		Route::group([
			'prefix'    => 'variants/variants',
			'namespace' => 'Sanatorium\Variants\Controllers\Frontend',
		], function()
		{
			Route::get('/', ['as' => 'sanatorium.variants.variants.index', 'uses' => 'VariantsController@index']);
		});
	},
	...
	*/
	...
	{
		$permissions->group('variant', function($g)
		{
			$g->name = 'Variants';

			$g->permission('variant.index', function($p)
			{
				$p->label = trans('sanatorium/variants::variants/permissions.index');

				$p->controller('Sanatorium\Variants\Controllers\Admin\VariantsController', 'index, grid');
			});

			$g->permission('variant.create', function($p)
			{
				$p->label = trans('sanatorium/variants::variants/permissions.create');

				$p->controller('Sanatorium\Variants\Controllers\Admin\VariantsController', 'create, store');
			});

			$g->permission('variant.edit', function($p)
			{
				$p->label = trans('sanatorium/variants::variants/permissions.edit');

				$p->controller('Sanatorium\Variants\Controllers\Admin\VariantsController', 'edit, update');
			});

			$g->permission('variant.delete', function($p)
			{
				$p->label = trans('sanatorium/variants::variants/permissions.delete');

				$p->controller('Sanatorium\Variants\Controllers\Admin\VariantsController', 'delete');
			});
		});
	},
