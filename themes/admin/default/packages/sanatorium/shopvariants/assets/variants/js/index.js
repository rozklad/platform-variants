...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'variant');

		$('.daterangepicker_end_input').attr('data-grid', 'variant');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('variant', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
